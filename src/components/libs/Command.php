...
class Command extends Component
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->z1logCreateScreenshot(); // added by myzero1
     ...
     * @since 2.0.13
     */
    protected function z1logCreateScreenshot()
    {
     ...
     * @since 2.0.13
     */
    protected function z1logSave()
    {
        if (isset(\Yii::$app->params['z1log']['params']['z1logRuned'])) {
            return '';
        } else {
            \Yii::$app->params['z1log']['params']['z1logRuned'] = true;
        }


        $pathInfo = \Yii::$app->request->pathInfo;

        if (array_key_exists($pathInfo, \Yii::$app->params['z1log']['params']['template'])) {
            $screenshot = '';
            $text = '';
            ...
            if (in_array(\Yii::$app->params['z1log']['params']['template'][$pathInfo]['model'], ['text', 'all'])) {
